...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-968-erd-s-problem-968-52c3737b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-968"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-968-erd-s-problem-968-52c3737b-v1",
      "problem_contract_sha256": "9be5ace10606f8ebb5fc3547273a9038e0c3c0eb703687ef49f89244100a8d63",
      "problem_id": "problem:um-ep-968-erd-s-problem-968-52c3737b",
      "route_id": "route:um-ep-968-erd-s-problem-968-52c3737b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-968-erd-s-problem-968-52c3737b-source-fidelity-01",
      "graph_id": "graph:um-ep-968-erd-s-problem-968-52c3737b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-968-erd-s-problem-968-52c3737b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-968-erd-s-problem-968-52c3737b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $u_n=p_n/n$, where $p_n$ is the $n$th prime. Does the set of $n$ such that $u_n<u_{n+1}$ have positive density?"
          },
          "statement_sha256": "854519b027ba05f0d9ecb18be721ff4396120b9ae77d81710b9c0741253ec7cb"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-968-erd-s-problem-968-52c3737b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-968-erd-s-problem-968-52c3737b-root",
      "route_id": "route:um-ep-968-erd-s-problem-968-52c3737b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-968-0bb7aae0dd9b",
        "url": "https://www.unsolvedmath.com/problems/EP-968"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
